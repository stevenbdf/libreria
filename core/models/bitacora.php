...
class Bitacora extends Validator
{
  ...
  {
    $sql = 'SELECT idBitacora, nombreEmpleado, fecha, accion FROM bitacora INNER JOIN empleado ON empleado.idEmpleado = bitacora.idUsuario ORDER BY idBitacora DESC';
    $params = array(null);

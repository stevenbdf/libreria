        ...
        content += `
            ...
            <div class="card pb-md-4 pb-lg-0 card-lift--hover shadow border-0">
                ...
                <div class="card-body">
                    ...
                    <a href="product.php?id=${row.idLibro}" class="btn btn-success float-left float-lg-none">Ver más</a> <a href="#"
                        class="btn btn-primary float-right float-lg-none"><i class="fas fa-shopping-cart"></i></a>
                </div>
            </div>

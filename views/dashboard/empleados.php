...
<body>
            ...
            <div class="row shadow-sm p-3 mb-5 bg-white rounded">
                <div class="table-responsive-lg" style="width:100%">
                    <h1 class="text-center text-uppercase mt-4 mb-4"
                        style="font-family: 'Arimo', sans-serif; font-size:50px;">Empleados</h1>
                    <div class="row d-flex justify-content-center">
                        <div class="col-6 col-md-4 text-center">
                            <button type="button" class="mr-lg-2 btn btn-success" data-toggle="modal"
                                data-target="#guardarEmpleadoModal">
    ...
    <div class="modal fade" id="guardarEmpleadoModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
    ...
    <div class="modal fade" id="modificarEmpleadoModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <form method="POST" id="form-update-empleado">
                        <div class="form-group">
                            ...
                            <input name="id-update" type="text" class="form-control form-control-alternative"
                                id="idEmpleado" readonly>

                            <div class="row">
                                <div class="col-6">
                                    <label for="recipient-name" class="col-form-label">Nombre:</label>
                                    <input name="nombres-update" type="text"
                                        class="form-control form-control-alternative" id="nombreEmpleado">
                                </div>
                                <div class="col-6">
                                    <label for="recipient-name" class="col-form-label">Apellido:</label>
                                    <input name="apellidos-update" type="text"
                                        class="form-control form-control-alternative" id="apellidoEmpleado">
                                </div>
                                <div class="col-6">
                                    <label for="recipient-name" class="col-form-label">Correo:</label>
                                    <input name="correo-update" type="text"
                                        class="form-control form-control-alternative" id="correoEmpleado">
                                </div>
                                <div class="col-6">
                                    <label for="recipient-name" class="col-form-label">Contraseña</label>
                                    <input name="contrasena-update" type="text"
                                        class="form-control form-control-alternative" id="contrasenaEmpleado">
                                </div>
                                <div class="col-6">
                                    <label for="recipient-name" class="col-form-label">DUI:</label>
                                    <input name="dui-update" type="text"
                                        class="form-control form-control-alternative" id="duiEmpleado">
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">

...
<body>
                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="col-6 col-md-4 text-center">
                            <button type="button" class="mr-lg-2 btn btn-success" data-toggle="modal"
                                data-target="#guardarCategoriaModal">
    ...
    <div class="modal fade" id="guardarCategoriaModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
    ...
    <div class="modal fade" id="modificarCategoriaModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <form method="POST" id="form-update-categoria">
                        <div class="form-group">
                            ...
                            <input name="id-update" type="text" class="form-control form-control-alternative"
                                id="idCategoria" readonly>

                            <div class="row">
                                <div class="col-6">
                                    <label for="recipient-name" class="col-form-label">Nombre:</label>
                                    <input name="nombres-update" type="text"
                                        class="form-control form-control-alternative" id="nombreCategoria">
                                </div>     
                            <div class="row">
                                <div class="col-6">
                                    <label for="recipient-name" class="col-form-label">Descuento:</label>
                                    <input name="descuento-update" type="text"
                                        class="form-control form-control-alternative" id="descuentoCategoria">
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">

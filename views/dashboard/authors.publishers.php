...
<div class="container-fluid mt--7">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6 col-lg-6 pt-auto">
                            <div class="input-group input-group-alternative mt-md-2 mt-lg-0">
                                ...
                                <input class="form-control form-control-alternative" placeholder="Buscar ..."
                                    type="text">
                            </div>
                        </div>
                        <div class="col-12 col-md-6 col-lg-4 offset-lg-2 mt-3 mt-md-0 d-flex justify-content-around">
                            <div class="icon icon-shape bg-success text-white rounded-circle shadow ml-md-2 ml-lg-0 mt-md-2 mt-lg-0"
                                data-toggle="tooltip" data-placement="top" title="Agregar">
                                <a href="#" data-toggle="modal" data-target="#guardarEditorialesModal">
                                    <i class="fas fa-plus"></i>
                                </a>
                            </div>
                            <div class="icon icon-shape bg-warning text-white rounded-circle shadow ml-md-2 ml-lg-3 mt-md-2 mt-lg-0"
                                data-toggle="tooltip" data-placement="top" title="Modificar">
                                <a href="#" data-toggle="modal" data-target="#modificarEditorialesModal">
                                    <i class="fas fa-pen"></i>
                                </a>
                            </div>
                            <div class="icon icon-shape bg-danger text-white rounded-circle shadow ml-md-2 ml-lg-3 mt-md-2 mt-lg-0"
                                data-toggle="tooltip" data-placement="top" title="Eliminar"
                                onclick="deleteAlert('Editorial')">
                                <a>
                ...
                <div class="modal-body">
                    <form method="POST" id="form-create-autor">
                        <div class="form-group">
                            ...
                            <input type="text" name="codigo" class="form-control form-control-alternative"
                                id="codigoAutor" readonly>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-warning" data-dismiss="modal"
                        onclick="modifyAlert('Autor')">Modificar</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="guardarEditorialesModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form>
                        <div class="form-group">
                            <label for="recipient-name" class="col-form-label">Codigo:</label>
                            <input type="text" class="form-control form-control-alternative" id="codigoEditorial"
                                readonly>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success" data-dismiss="modal"
                        onclick="savedAlert('Editorial')">Guardar</button>
                </div>
            </div>
        </div>
    </div>

    <div class="modal fade" id="modificarEditorialesModal" tabindex="-1" role="dialog"
                ...
                <div class="modal-body">
                    <form>
                        <div class="form-group">
                            ...
                            <label for="recipient-name" class="col-form-label">Dirección:</label>
                            <input type="text" class="form-control form-control-alternative" id=direccionEditorial
                                value="Travessera de Gracia, 47-49
Barcelona 08021 Barcelona ">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <label for="recipient-name" class="col-form-label">Telefono:</label>
                                    <input type="text" class="form-control form-control-alternative"
                                        id="telefonoEditorial" value="+93 3660300">
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                    <button type="button" class="btn btn-warning" data-dismiss="modal"
                        onclick="modifyAlert('Editorial')">Modificar</button>
                </div>
            </div>
        </div>
    </div>
